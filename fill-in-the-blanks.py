easy_mad_lib = """HyperText Markup Language (___1___) is the standard markup language for creating web pages
and web applications. With Cascading Style Sheets (___2___), and ___3___, it forms a triad of cornerstone
technologies for the World Wide Web. Web browsers receive ___1___ documents from a webserver or from local
storage and render them into multimedia web pages. ___1___ describes the structure of a web page semantically
and originally included cues for the appearance of the ___4___."""
easy_answers = ["HTML", "CSS", "JavaScript", "document"]

medium_mad_lib = """___1___ is a widely used high-level, general-purpose, interpreted, dynamic programming language.
Its design philosophy emphasizes code readability, and its syntax allows programmers to express concepts in fewer lines
of code than possible in languages such as C++ or Java. The language provides constructs intended to enable writing ___2___
programs on both a small and large scale. ___1___ supports multiple programming paradigms, including object-___3___,
imperative, ___4___ programming, and procedural styles. It features a dynamic type system and automatic memory management
and has a large and comprehensive standard library."""
medium_answers = ["Python", "clear", "oriented", "functional"]

hard_mad_lib = """A video ___1___ is an electronic ___1___ that involves human interaction with a user interface to
generate visual feedback on a video device such as a ___2___ screen or ___3___ monitor. The word video in video ___1___
traditionally referred to a raster display device, but as of the 2000s, it implies any type of display device that
can produce two- or three-dimensional images. Some theorists categorize video games as an ___4___ form, but this
